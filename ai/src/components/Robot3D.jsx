    ...
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      >
        ...
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-32 h-32 bg-gradient-to-b from-gray-200/90 via-gray-300/90 to-gray-400/90 dark:from-gray-600/90 dark:via-gray-700/90 dark:to-gray-800/90 rounded-full border-4 border-gray-300/80 dark:border-gray-500/80 shadow-lg backdrop-blur-sm">
          ...
          {/* Eyes */}
          <div className="absolute top-8 left-6 w-6 h-6 bg-gradient-to-br from-blue-400/90 to-blue-600/90 dark:from-blue-500/90 dark:to-blue-700/90 rounded-full border-2 border-blue-300/80 dark:border-blue-400/80">
            <motion.div
          ...
          <div className="absolute top-8 right-6 w-6 h-6 bg-gradient-to-br from-blue-400/90 to-blue-600/90 dark:from-blue-500/90 dark:to-blue-700/90 rounded-full border-2 border-blue-300/80 dark:border-blue-400/80">
            <motion.div
              className="w-3 h-3 bg-white/90 dark:bg-gray-200/90 rounded-full absolute top-1 left-1"
              animate={{
                scale: [1, 1.1, 1],
        ...
        {/* Arms */}
        <div className="absolute top-16 -left-4 w-6 h-20 bg-gradient-to-b from-gray-300/90 to-gray-500/90 dark:from-gray-600/90 dark:to-gray-700/90 rounded-full border-2 border-gray-300/80 dark:border-gray-500/80">
          <div className="w-4 h-4 bg-gray-400/90 dark:bg-gray-600/90 rounded-full absolute -left-1 top-0"></div>
        </div>
        
        <div className="absolute top-16 -right-4 w-6 h-20 bg-gradient-to-b from-gray-300/90 to-gray-500/90 dark:from-gray-600/90 dark:to-gray-700/90 rounded-full border-2 border-gray-300/80 dark:border-gray-500/80">
          <div className="w-4 h-4 bg-gray-400/90 dark:bg-gray-600/90 rounded-full absolute -right-1 top-0"></div>
        </div>

        {/* Legs */}
        <div className="absolute bottom-0 left-8 w-8 h-16 bg-gradient-to-b from-gray-400/90 to-gray-600/90 dark:from-gray-700/90 dark:to-gray-800/90 rounded-full border-2 border-gray-400/80 dark:border-gray-600/80">
        ...
        <div className="absolute bottom-0 right-8 w-8 h-16 bg-gradient-to-b from-gray-400/90 to-gray-600/90 dark:from-gray-700/90 dark:to-gray-800/90 rounded-full border-2 border-gray-400/80 dark:border-gray-600/80">
          <div className="w-10 h-4 bg-gray-500/90 dark:bg-gray-700/90 rounded-full absolute -bottom-2 left-1/2 transform -translate-x-1/2"></div>
        </div>
